...
export const VAULT_CONTRACTS_WITH_3009: Array<string> = VAULT_CONTRACTS_V4_2_ANDUP
export const VAULT_CONTRACTS_WITH_GASLES_REVOKE: Array<string> = VAULT_CONTRACTS_V4_2_ANDUP
